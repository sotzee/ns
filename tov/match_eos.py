...
args_6=match_eos4([n_s,n1,p1,e1,0.*dpdn1,n2,p2,e2])
eos_array_list.append(match_get_eos_array_equations4(np.linspace(n1/n_s,n2/n_s,100),args_6))
eos_label_list.append('type 6')
