...
pressure1_max = 30.
tidal1_upper_30,tidal2_upper_30,eos_args_upper_30 = get_bound(q,m1_grid,m2_grid,[maxmass_min,maxmass_max],[pressure1_min,pressure1_max],'upper')
pressure1_max = 20.
tidal1_upper_20,tidal2_upper_20,eos_args_upper_20 = get_bound(q,m1_grid,m2_grid,[maxmass_min,maxmass_max],[pressure1_min,pressure1_max],'upper')
...
pressure1_min = 3.74
tidal1_lower_no_maxmass_max_374,tidal2_lower_no_maxmass_max_374,eos_args_no_maxmass_max_374 = get_bound(q,m1_grid,m2_grid,[maxmass_min,maxmass_max],[pressure1_min,pressure1_max],'lower_no_maxmass_max')
pressure1_min = 8.4
tidal1_lower_no_maxmass_max_840,tidal2_lower_no_maxmass_max_840,eos_args_no_maxmass_max_840 = get_bound(q,m1_grid,m2_grid,[maxmass_min,maxmass_max],[pressure1_min,pressure1_max],'lower_no_maxmass_max')


#np.savetxt('hybrid_bound_1.188.txt',np.array([q,tidal1_upper_30[:,0],tidal2_upper_30[:,0],tidal1_upper_20[:,0],tidal2_upper_20[:,0],tidal1_lower_no_maxmass_max_374[:,0],tidal2_lower_no_maxmass_max_374[:,0],tidal1_lower_no_maxmass_max_840[:,0],tidal2_lower_no_maxmass_max_840[:,0]]).transpose())
#np.savetxt('hybrid_bound_1.188.txt',np.array([q,tidal1_upper_30[:,0],tidal2_upper_30[:,0],tidal1_upper_20[:,0],tidal2_upper_20[:,0],tidal1_lower_no_maxmass_max_374[:,0],tidal2_lower_no_maxmass_max_374[:,0],tidal1_lower_no_maxmass_max_840[:,0],tidal2_lower_no_maxmass_max_840[:,0]]).transpose())
#np.savetxt('out.txt',tidal1_upper_30.transpose())
...
tidal1_upper=tidal1_upper_30
tidal2_upper=tidal2_upper_30
tidal1_lower=tidal1_lower_no_maxmass_max_374
tidal2_lower=tidal2_lower_no_maxmass_max_374
tidal1_lower_no_maxmass_max=tidal1_lower_no_maxmass_max_374
tidal2_lower_no_maxmass_max=tidal2_lower_no_maxmass_max_374
